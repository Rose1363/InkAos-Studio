...
const AddStyleDesign = ({ close, fetchData }) => {
  ...
  const handleUploadStyleDesignImage = async (e) => {
    ...
    <section className="bg-black/70 fixed inset-0 z-50 flex items-center justify-center">
      <div className="bg-white mx-auto w-full max-w-lg rounded-md shadow-xl">
        <div className="flex justify-between shadow-md p-5 text-xl">
          <h2 className="font-semibold">Thêm phong cach</h2>
        ...
        <form onSubmit={handleSubmit} className="p-4  grid gap-4">
          <div className="grid gap-1">
            <label htmlFor="categoryName">Tên phong cach </label>
            <input
              type="text"
              id="categoryName"
              placeholder="Nhập tên phong cach"
              value={data.name}
              name="name"
          ...
          <div className="">
            ...
            <div className="flex gap-3 items-center">
              ...
              <label htmlFor="uploadCategoryImage">
                ...
                <input
                  disabled={!data.name}
                  onChange={handleUploadStyleDesignImage}
                  type="file"
                  name=""
          ...
          >
            {loading ? <Loading size="medium" /> : "Thêm phong cach"}
          </button>
        </form>
      </div>
    </section>
