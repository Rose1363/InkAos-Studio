      ...
      <div className="bg-white shadow-2xl my-20 w-full max-w-lg mx-auto rounded-md p-8">
        ...
        <form className="grid mt-6 py-4" onSubmit={handleSubmit}>
          ...
          <div className="grid gap-1">
            ...
            <Link
              to={"/forgot-password"}
              className="block ml-auto text-xs text-primary-darker hover:underline "
            >
              Quên mật khẩu?
            </Link>
          </div>
          ...
          <button
            ...
            className={` ${
              valideValue
                ...
                : " bg-gray-500"
            } text-white text-xl font-semibold mt-7 
                    py-2 tracking-wide`}
          >
            Đăng Nhập
          </button>
        ...
        <p className="text-center text-gray-500">
          ...
          <Link
            to="/signup"
            className="text-primary-darker hover:underline ml-1"
          >
            Đăng kí
          </Link>
        </p>
